...
class PhraseTrigger(Trigger):
    ...
    def evaluate(self, story):
        if self.isPhraseIn(story.getSummary()) or \
...
def filterStories(stories, triggerlist):
    """
    Takes in a lit of NewsStory instances.
    ...
    for story in stories:
        for trig in triggerlist:
            # if any of the triggers fires, add the story and move on
...
def makeTrigger(triggerMap, triggerType, params, name):
    ...
    """
    newTrig = None
    # make trigger object based on type and parameters provided
    if triggerType == "TITLE":
        ...
        raise Exception("Bad trigger type: " + triggerType)

    # add new trigger to map using name as key
